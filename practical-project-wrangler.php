...
if( !class_exists( 'PPW' ) ) {
  class PPW {
    ...
    private function includes() {
      ...
      require_once PPW_PLUGIN_DIR . 'admin/classes/class-ppw-metabox-clients.php';
      require_once PPW_PLUGIN_DIR . 'admin/classes/class-ppw-meta-boxes-users.php';
      ...
      // includes helpers
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-plugin-part.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-enqueue-if-registered.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-close-comments.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-attribute.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-project-user-avatars.php';
      ...
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-employee-users.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-active-clients.php';
      require_once PPW_PLUGIN_DIR . 'includes/helpers/class-ppw-helper-get-all-clients.php';
      ...
      // shortcodes
      require_once PPW_PLUGIN_DIR . 'includes/shortcodes/class-ppw-shortcode-registration-form.php';
      ...
      // includes classes
      require_once PPW_PLUGIN_DIR . 'includes/classes/class-ppw-single-templates.php';
      require_once PPW_PLUGIN_DIR . 'includes/classes/class-ppw-project-autocomplete.php';
      require_once PPW_PLUGIN_DIR . 'includes/classes/class-ppw-project-ajax-search.php';
