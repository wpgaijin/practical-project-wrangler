...
function ppw_render_search( $field, $escaped_value, $object_id, $object_type, $field_object_type ) {
	...
	<?php
} // end ppw_render_search
add_filter( 'cmb2_render_search', 'ppw_render_search', 10, 5 );

function ppw_search_sanitize( $override_value, $value ){
	return $value;
} // sfn_chosen_sanitize
add_filter( 'cmb2_sanitize_ppw_search', 'ppw_search_sanitize', 10, 2 );