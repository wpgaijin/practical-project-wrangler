<?php
$ppw_field_clients_state_select_field_classes = apply_filters( 'ppw_field_clients_state_select_field_classes', array( 'ppw__select' ) );
$ppw_field_clients_state_th_classes           = apply_filters( 'ppw_field_clients_state_th_classes', array( 'ppw__th' ) );
$ppw_field_clients_state_td_classes           = apply_filters( 'ppw_field_clients_state_td_classes', array( 'ppw__td' ) );
$ppw_clients_state                            = get_post_meta( get_the_ID(), PPW_PREFIX . '_clients_state', true );
$ppw_clients_state_value                      = isset( $ppw_clients_state ) ? $ppw_clients_state : '' ;
$states                                       = array(
...
?>
<div <?php echo ppw_get_attribute( 'class', $ppw_field_clients_state_th_classes ) ?>>
  <lable for="<?php echo PPW_PREFIX; ?>_clients_state"><?php _e( 'State', PPW_TEXTDOMAIN ); ?></lable>
</div>
<div <?php echo ppw_get_attribute( 'class', $ppw_field_clients_state_td_classes ) ?>>
  <select <?php echo ppw_get_attribute( 'class', $ppw_field_clients_state_select_field_classes ) ?> name="<?php echo PPW_PREFIX; ?>_clients_state" id="<?php echo PPW_PREFIX; ?>_clients_state">
  <?php
    foreach( $states as $key => $value ) {
      ?>
      <option value="<?php echo $key; ?>" <?php selected( $ppw_clients_state_value, $key ); ?>><?php echo $value; ?></option>
      <?php
    }
  ?>
  </select>
